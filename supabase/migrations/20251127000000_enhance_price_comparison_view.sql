-- Migration: Enhance Price Comparison View with Receipt Unit Info
-- Description: Updates view_price_comparison to prioritize unit information (quantity_unit, content_amount, content_unit)
-- extracted from receipts by the AI, falling back to product mappings only when necessary.
